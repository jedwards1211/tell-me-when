...
import type { AddFn, DateFn } from '../DateFn'
...
export const FullYear = token(/\d{4}/).parseAs(FullYearNode)
...
export const MonthNum = token(/1[0-2]|0?[1-9]/).parseAs(MonthNumNode)
...
export const DayOfMonthNum = token(/[12][0-9]|3[01]|0?[1-9]/).parseAs(
  DayOfMonthNumNode
)
